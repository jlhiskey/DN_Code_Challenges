...
# EC1: Mock Interview Implementation
...
## Approach & Efficiency
### Approach
- During the actual interview I implemented the formula n = (n - 1) + (n - 2) and did this by creating a look that ran (n times) and would add the previous two values of n together to generate the current n.
- I decided for fun to try out the Golden Ratio solution uses the golden ratio in a formula to calcuate the nth value of the Fibonacci sequence.

    ![](https://www.mathsisfun.com/numbers/images/fibonacci-formula-phi.png)
