...
namespace StacksAndQueuesTests
{
    ...
    public class QueueTestSuite
    {
        ...
        [Fact]
        public void TestingDequeueOfTwosNodeFromThreeExistingNodes()
        {
            Node test = new Node(1);
            Queue testQueue = new Queue(test);
            testQueue.Enqueue(2);
            testQueue.Enqueue(3);
            testQueue.Dequeue();
            Assert.Equal(2, testQueue.Dequeue().Value);
        }

        [Fact]
        public void TestingDequeueOfEmptyQueue()
        {
            Queue testQueue = new Queue();
        ...
        [Fact]
        public void TestingPeekOfNewlyCreatedQueueWithNode()
        {
            Node test = new Node(1);
            Queue testQueue = new Queue(test);
            Assert.Equal(test, testQueue.Peek());
        ...
        [Fact]
        public void TestingPeekOfQueueWithThreeNodesThenDequeueOfOneNode()
        {
            Node test = new Node(1);
            Queue testQueue = new Queue(test);
            testQueue.Enqueue(2);
            testQueue.Enqueue(3);
            testQueue.Dequeue();
            Assert.Equal(2, testQueue.Peek().Value);
        }

        [Fact]
        public void TestingPeekOfQueueWithNoNodes()
        {
            Queue testQueue = new Queue();
            Assert.Null(testQueue.Peek());
        }
        ...
        [Fact]
        public void TestingGetSizeOfNewlyCreatedQueueWithNode()
        {
            Node test = new Node(1);
            Queue testQueue = new Queue(test);
            Assert.Equal(1, testQueue.GetSize());
        }

        [Fact]
        public void TestingGetSizeOfNewlyCreatedEmptyQueue()
        {
            Node test = new Node(1);
            Queue testQueue = new Queue();
            Assert.Equal(0, testQueue.GetSize());
        }

        [Fact]
        public void TestingGetSizeOfQueueWithThreeNodesThenDequeueOfOneNode()
        {
            Node test = new Node(1);
            Queue testQueue = new Queue(test);
            testQueue.Enqueue(2);
